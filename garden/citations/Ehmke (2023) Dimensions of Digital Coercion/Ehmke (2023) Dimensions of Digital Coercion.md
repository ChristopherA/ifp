...
citation_slug: ehmke-2023-digital-coercion
publication_year: 2023
canonical: "https://ethicalsource.dev/publications/digital-coercion"
brief_summary: "Four-dimensional framework for digital coercion: attention (excessive cognitive demands), ergonomic (autonomy/usability tradeoffs), trust (unaccountable benign intent assumptions), and cultural (Western norm imposition). Applies the same analytical lens to both commercial and open-source platforms, challenging the assumption that openness alone produces equity."
tagline: "Four dimensions of digital coercion that persist across commercial and open-source platforms alike"
migrated_from: "analysis/library/2023-ehmke-digital-coercion"
...
- cites_work_by::[\[\[Coraline Ada Ehmke\]\]⊙](../../EXTERNAL.html#:~:text=Coraline%20Ada%20Ehmke)

# Ehmke (2023) Dimensions of Digital Coercion

## Bibliographic Entry

* _**Dimensions of Digital Coercion**_ (2023). [white paper]. _Ehmke, Coraline Ada._ Organization for Ethical Source, February 2023. 13 pages, ~4,000 words. CC BY-NC 4.0. Retrieved 2025-11-20 from: <https://ethicalsource.dev/publications/digital-coercion>

## Summary

Ehmke presents digital coercion as "the manifestation of mechanisms of control in online environments" and identifies four dimensions: attention coercion (demanding excessive time or cognitive load), ergonomic coercion (forcing autonomy/usability tradeoffs), trust coercion (demanding trust without accountability), and cultural coercion (imposing Western norms as participation prerequisites). The analysis applies the same framework to both commercial and open-source platforms, demonstrating that openness alone does not prevent coercion. Proposes multi-layered standards (regulatory, technical, normative, ethical) as accountability mechanisms.
...
- [\[\[Brignull (2010) Deceptive Patterns Dark Patterns\]\]⊙](../../EXTERNAL.html#:~:text=Brignull%20%282010%29%20Deceptive%20Patterns%20Dark%20Patterns) — Dark patterns are the interface-level mechanisms of attention and ergonomic coercion
- [\[\[Spiekermann and Pallas (2006) Technology Paternalism\]\]⊙](../../EXTERNAL.html#:~:text=Spiekermann%20and%20Pallas%20%282006%29%20Technology%20Paternalism) — "Right to the last word" addresses ergonomic and trust coercion

**Vault clipping**: [\[\[Dimensions of Digital Coercion\]\]⊙](../../EXTERNAL.html#:~:text=Dimensions%20of%20Digital%20Coercion) (Clippings/Identity/)
...
- relates_to::[\[\[Coercion Resistance as Replacement Framing\]\]⊙](../../EXTERNAL.html#:~:text=Coercion%20Resistance%20as%20Replacement%20Framing)
