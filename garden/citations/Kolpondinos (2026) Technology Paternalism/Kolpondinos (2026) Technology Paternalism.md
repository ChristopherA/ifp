...
citation_slug: kolpondinos-2026-technology-paternalism
publication_year: 2026
canonical: "https://www.kosmaconnect.net/interactionblog/technologypaternalism"
brief_summary: "Names Technology Paternalism as an anti-pattern with four forms: Design (dark patterns, defaults), Algorithmic (filter bubbles), Infrastructural (lock-in), and Protective (safety-justified restrictions). Extends to agentic AI and digital identity. Proposes four countermeasures: override, contest, inspect, and exit."
...
- Primary: Kolpondinos, M. (2026). Technology Paternalism. KosmaConnect.
- Secondary: LinkedIn discussion thread (March 2026) — replies from Drummond Reed (Trust over IP), Platformocracy (guardianship critique)
- Referenced: Spiekermann & Pallas (2006) on ubiquitous computing and "right to the last word"; Pariser on filter bubbles; OECD on data portability; EU Data Act; EU AI Act; Cloud Security Alliance survey (2026); Deloitte agentic AI report (2026)
...
relates_to::[\[\[Dimensions of Digital Coercion\]\]⊙](../../EXTERNAL.html#:~:text=Dimensions%20of%20Digital%20Coercion)
extends::[\[\[Coercion Resistance\]\]⊙](../../EXTERNAL.html#:~:text=Coercion%20Resistance)
relates_to::[\[\[Choice Architecture\]\]⊙](../../EXTERNAL.html#:~:text=Choice%20Architecture)
relates_to::[\[\[Martina Kolpondinos\]\]⊙](../../EXTERNAL.html#:~:text=Martina%20Kolpondinos)
