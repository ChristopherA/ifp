...
* _**The Preference for Self-Correction in the Organization of Repair in Conversation**_ (1977). [journal article]. _Schegloff, Emanuel A.; Jefferson, Gail; Sacks, Harvey._ *Language*, Vol. 53, No. 2, pp. 361-382. Retrieved from: <https://www.semanticscholar.org/paper/The-preference-for-self-correction-in-the-of-repair-Schegloff-Jefferson/191a416ea8d6673a7c2ceecc3b36e2b118430ccd>
...
- relates_to::[\[\[Errors as Negotiation Opportunities\]\]](../../patterns/Errors%20as%20Negotiation%20Opportunities.html)
  The repair preference hierarchy demonstrates that errors in conversation are not failures but structured opportunities for participants to negotiate understanding. Self-correction preserves the error-producer's agency; other-initiation creates a collaborative repair sequence.

- relates_to::[\[\[Conversational Repair Organization\]\]](../../models/Conversational%20Repair%20Organization.html)
  This paper is the primary source for the Conversational Repair Organization model. Schegloff, Jefferson, and Sacks define the taxonomy and preference organization that the model explores across different interaction contexts.
