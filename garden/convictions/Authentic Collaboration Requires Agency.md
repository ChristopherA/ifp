...
1. The world's important problems require collaboration
2. Authentic collaboration requires agency
3. Therefore, agency infrastructure is prerequisite to solving the world's important problems
...
- [Blockchain Commons Values & Design Principles](https://www.blockchaincommons.com/musings/ValuesDesign/)
- Group Works Project. *Group Works: A Pattern Language for Bringing Life to Meetings and Other Gatherings*

## Relations

- grounds::[\[\[Agency Before Collaboration\]\]⊙](../EXTERNAL.html#:~:text=Agency%20Before%20Collaboration) — the principle derived from this conviction (future)
...
- relates_to::[\[\[Precondition Stack for Joint Action\]\]⊙](../EXTERNAL.html#:~:text=Precondition%20Stack%20for%20Joint%20Action) — the model that operationalizes this conviction (future)
