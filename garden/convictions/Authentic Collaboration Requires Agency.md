...
- grounds::[\[\[Agency Before Collaboration\]\]↑](../NODES.html#:~:text=Agency%20Before%20Collaboration) — the principle derived from this conviction (future)
...
- relates_to::[\[\[Precondition Stack for Joint Action\]\]↑](../NODES.html#:~:text=Precondition%20Stack%20for%20Joint%20Action) — the model that operationalizes this conviction (future)
