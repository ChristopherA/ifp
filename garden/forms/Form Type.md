...
| [\[\[Reference Form\]\]⊙](../EXTERNAL.html#:~:text=Reference%20Form) | What do I need to know about this domain to act effectively? |
...
| [\[\[Case Form\]\]⊙](../EXTERNAL.html#:~:text=Case%20Form) | What happened when this was tried? |
| [\[\[Decision Form\]\]](Decision%20Form.html) | Why did we choose this over the alternatives? |
| [\[\[Protocol Form\]\]⊙](../EXTERNAL.html#:~:text=Protocol%20Form) | How do independent parties coordinate reliably? |
| [\[\[Skill Form\]\]⊙](../EXTERNAL.html#:~:text=Skill%20Form) | How does an agent execute this reliably? |
...
| [\[\[Scenario Form\]\]⊙](../EXTERNAL.html#:~:text=Scenario%20Form) | What might happen if these forces play out? |
