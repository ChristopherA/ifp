...
- relates_to::[\[\[Structural Retrieval Hierarchy\]\]⊙](../EXTERNAL.html#:~:text=Structural%20Retrieval%20Hierarchy) — growing nodes rank in the first retrieval tier alongside evergreen
