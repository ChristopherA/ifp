...
- `authored_by::[\[\[Person\]\]⊙](../EXTERNAL.html#:~:text=Person)` -- who wrote the content
- `principal::[\[\[Person\]\]⊙](../EXTERNAL.html#:~:text=Person)` -- who directed the work and bears ultimate responsibility (from agency law; see [\[\[Principal Authority as Agency Law for Digital Identity\]\]](../glosses/Principal%20Authority%20as%20Agency%20Law%20for%20Digital%20Identity.html))

### Recommended

- `copyright_held_by::[\[\[Person\]\]⊙](../EXTERNAL.html#:~:text=Person)` -- legal ownership (distinct from authorship)
- `produced_by::[\[\[Person\]\]⊙](../EXTERNAL.html#:~:text=Person)` -- who made the work happen as a creative project (from film/game industry usage; often the same as principal but carries different connotation)

### As Needed

- `foreword_by::[\[\[Person\]\]⊙](../EXTERNAL.html#:~:text=Person)` -- foreword contributor
- `illustrated_by::[\[\[Person\]\]⊙](../EXTERNAL.html#:~:text=Person)` -- illustrator
- `contributed_by::[\[\[Person\]\]⊙](../EXTERNAL.html#:~:text=Person)` -- catch-all for other roles
- `edited_by::[\[\[Person\]\]⊙](../EXTERNAL.html#:~:text=Person)` -- editor
- `translated_by::[\[\[Person\]\]⊙](../EXTERNAL.html#:~:text=Person)` -- translator
...
- `in_series::[\[\[Series Title\]\]⊙](../EXTERNAL.html#:~:text=Series%20Title)` -- membership in a thematic collection
- `inspired_by::[\[\[Source\]\]⊙](../EXTERNAL.html#:~:text=Source)` -- intellectual lineage
- `extends::[\[\[Other Opus\]\]⊙](../EXTERNAL.html#:~:text=Other%20Opus)` -- when one work builds on another
- `develops_from::[\[\[Other Opus\]\]⊙](../EXTERNAL.html#:~:text=Other%20Opus)` -- earlier work this one grew out of
- `presents::[\[\[Garden Node\]\]⊙](../EXTERNAL.html#:~:text=Garden%20Node)` -- references garden Pattern, Model, or other nodes the work discusses
...
- [\[\[Sociosocratic Learning & Seminars\]\]⊙](../EXTERNAL.html#:~:text=Sociosocratic%20Learning%20%26%20Seminars) -- Seed stage, compound (analysis.md + insights.md). Solo-authored essay on collaborative learning, published as GitHub Gist. Develops from the Hybrid Flipped Learning presentation.
- [\[\[My Hybrid Flipped Learning Environment\]\]⊙](../EXTERNAL.html#:~:text=My%20Hybrid%20Flipped%20Learning%20Environment) -- Seed stage, compound (lead article + Expressions/ with SlideShare sidecar). ~5,000-word article expanding a 2013 faculty presentation on game-design-informed pedagogy. Published on SlideShare (abbreviated).
- [\[\[Field Notes on Handpan Sound Models & Instruments\]\]⊙](../EXTERNAL.html#:~:text=Field%20Notes%20on%20Handpan%20Sound%20Models%20%26%20Instruments) -- Seed stage, dual-format compound (interactive HTML + portable markdown per instrument). Web-publishable reference work with code assets, requirements docs, and a 2014 precursor article as Rendition. Demonstrates Opus Form handling of hybrid web/vault content.
...
- [\[\[The Gardening Problem Returns\]\]⊙](../EXTERNAL.html#:~:text=The%20Gardening%20Problem%20Returns) -- "authorship is not performance but responsibility"
...
- relates_to::[\[\[Case Form\]\]⊙](../EXTERNAL.html#:~:text=Case%20Form) -- opuses may contain case studies
- relates_to::[\[\[Reference Form\]\]⊙](../EXTERNAL.html#:~:text=Reference%20Form) -- references synthesize knowledge; opuses are original contributions
- relates_to::[\[\[Research Form\]\]⊙](../EXTERNAL.html#:~:text=Research%20Form) -- research investigates; opuses articulate
