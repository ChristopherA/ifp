...
Wikilinks within a patch (`[[Node Name]]`) resolve within the patch directory. Links to the source garden or external works use URLs, not wikilinks, since the source garden may not be published.
