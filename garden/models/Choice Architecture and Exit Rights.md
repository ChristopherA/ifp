...
This model covers structural lock-in and exit costs. Psychological effects of lock-in awareness (self-censorship) are in [\[\[Self-Coercion Through Surveillance Awareness\]\]⊙](../EXTERNAL.html#:~:text=Self-Coercion%20Through%20Surveillance%20Awareness). Interface manipulation that creates the initial adoption is in [\[\[Coercion Resistance as Meta-Lens\]\]](Coercion%20Resistance%20as%20Meta-Lens.html).
