...
# Precinct Boundaries Govern Sharing Not Quality

The two precincts — [Garden Precinct](../glosses/Garden%20Precinct.html) and [Vault Precinct](../glosses/Vault%20Precinct.html) — are not quality tiers. A meeting note is not a "lesser" document waiting to graduate into a garden node. They serve different purposes with different sharing properties.
...
- relates_to::[Garden Precinct](../glosses/Garden%20Precinct.html)
  - Garden nodes are the shared-by-default precinct.

- relates_to::[Vault Precinct](../glosses/Vault%20Precinct.html)
  - Vault documents are the context-dependent precinct.
...
- relates_to::[Garden Patch as Composable Knowledge Fragment](../glosses/Garden%20Patch%20as%20Composable%20Knowledge%20Fragment.html)
  - Patches contain only garden-precinct content. This is why they can be shared openly.
...
- relates_to::[Collaborative Meeting as Composable Knowledge Pipeline](Collaborative%20Meeting%20as%20Composable%20Knowledge%20Pipeline.html)
  - The pipeline crosses the precinct boundary at Stage 5 (garden integration). Stages 1-4 produce vault-precinct outputs; Stages 5-6 produce garden-precinct outputs.
